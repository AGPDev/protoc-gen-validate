...
cc_proto_gen_validate = rule(
    attrs = {
        ...
        "_plugin": attr.label(
            cfg = "host",
            default = Label("@com_AGPDev_protoc_gen_validate//:protoc-gen-validate"),
            allow_files = True,
            executable = True,
        ),
...
java_proto_gen_validate = rule(
    attrs = {
        ...
        "_validate_deps": attr.label_list(
            default = [
                Label("@com_AGPDev_protoc_gen_validate//validate:validate_java"),
                Label("@com_google_re2j//jar"),
                Label("@com_google_protobuf//:protobuf_java"),
                Label("@com_google_protobuf//:protobuf_java_util"),
                Label("@com_AGPDev_protoc_gen_validate//java/pgv-java-stub/src/main/java/io/AGPDev/pgv"),
                Label("@com_AGPDev_protoc_gen_validate//java/pgv-java-validation/src/main/java/io/AGPDev/pgv"),
            ],
        ),
